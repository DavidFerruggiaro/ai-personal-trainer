...
- The next ranked product candidate is M2.14a, a Foundation-only in-memory session-summary projection. It has not started; M2.13 persistence/history/video retention, clean-gate scoring, coaching, cloud/backend work, and exercise expansion remain deferred pending explicit approval.
